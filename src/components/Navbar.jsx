      ...
      className={`fixed top-0 left-0 right-0 z-40 ${
        scrolled
          ? darkMode
            ...
            : "bg-[#f0f4f8]/80 backdrop-blur-md shadow-md border-b border-gray-200"
          : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button
              ...
              className={`w-9 h-9 rounded-lg inline-flex items-center justify-center ${darkMode ? "icon-btn text-white" : "text-gray-700 border border-gray-300 hover:border-gray-500 hover:bg-gray-100"}`}
      ...
      {mobileOpen && (
        <div className={`md:hidden border-t backdrop-blur-2xl ${
          darkMode 
            ? "border-white/5 bg-[#0a0a0f]/98" 
            : "border-gray-200 bg-[#f0f4f8]/98"
        }`}>
