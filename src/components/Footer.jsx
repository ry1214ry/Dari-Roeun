...
const TwitterIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M17.751 3h3.067l-6.7 7.625L22 21h-6.172l-4.833-6.293L5.464 21H2.395l7.167-8.156L2 3h6.328l4.37 5.752L17.75 3Zm-1.076 16.172h1.7L7.404 4.732H5.58l11.095 14.44Z"/></svg>
);
...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/5 bg-gradient-to-b from-transparent to-[#00abf0]/[0.02]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-6 text-center sm:text-left">
          <div className="text-xs sm:text-sm text-gray-500 order-3 sm:order-1">
            <p>&copy; {year} <span className="text-[#00abf0]">Dev</span>eloper. All rights reserved.</p>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 order-2 sm:order-3">
            <p className="text-[10px] sm:text-sm text-gray-500 flex items-center gap-1">
              Made with <Heart size={10} className="text-red-500 fill-red-500" /> using React
            </p>
            <button
              onClick={scrollToTop}
              className="icon-btn !w-8 !h-8 sm:!w-9 sm:!h-9"
